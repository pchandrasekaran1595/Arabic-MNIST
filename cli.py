...
def get_images_and_labels_from_csv(train=True):
    if train:
        images = pd.read_csv(os.path.join(u.DATA_PATH, "Train Images.csv"), engine="python")
        labels = pd.read_csv(os.path.join(u.DATA_PATH, "Train Labels.csv"), engine="python")
    else:
        images = pd.read_csv(os.path.join(u.DATA_PATH, "Test Images.csv"), engine="python")
        labels = pd.read_csv(os.path.join(u.DATA_PATH, "Test Labels.csv"), engine="python")
...
def build_train_and_valid_loaders(batch_size=None, augment=False):
    images, labels = get_images_and_labels_from_csv(train=True)
...
def test_set_accuracy(model, batch_size):
    images, labels = get_images_and_labels_from_csv(train=False)
